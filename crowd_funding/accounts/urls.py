...
from accounts.views import AccountCreateView, ProfileDetailView, ProfileUpdateView, ProfileDeleteView,ActivationSuccessView, ActivationFailureView, ActivationRequiredView, profile, activate, password_change, password_reset_request, passwordResetConfirm, DashboardProfileView
urlpatterns = [
    ...
    path('profile/<int:pk>/', DashboardProfileView.as_view(), name='dashboard.profile'),
